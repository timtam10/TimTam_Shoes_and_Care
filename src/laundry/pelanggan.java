...
//    }
    ...
    private void initComponents() {
        ...
        hapus.setBackground(new java.awt.Color(84, 140, 168));
        hapus.setText("HAPUS");
        ...
        jLabel9.setText("Jenis Treatment");
        ...
        hitung.setBackground(new java.awt.Color(84, 140, 168));
        ...
        reset.setBackground(new java.awt.Color(84, 140, 168));
        reset.setText("RESET");
        ...
        simpan.setBackground(new java.awt.Color(84, 140, 168));
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        ...
        if (j_pewangi.getSelectedIndex() == 0) {
            ...
            harga_pewangi = 30000;
        } else if (j_pewangi.getSelectedIndex() == 3 ){
            harga_pewangi = 100000;
        }
        int totall = 0;
        totall = Integer.parseInt(String.valueOf(jumlah.getText()));
        int total = (int) ((totall * 5000) + harga_pewangi);
